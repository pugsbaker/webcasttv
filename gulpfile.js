...
gulp.task("pl-copy:js", function() {
  return gulp
    .src("**/*.js", {
      cwd: normalizePath(paths().source.js)
    })
...
gulp.task("pl-copy:img", function() {
  return gulp
    .src("**/*.*", {
      cwd: normalizePath(paths().source.images)
    })
...
gulp.task("pl-copy:favicon", function() {
  return gulp
    .src("favicon.ico", {
      cwd: normalizePath(paths().source.root)
    })
...
gulp.task("pl-copy:font", function() {
  return gulp
    .src("*", {
      cwd: normalizePath(paths().source.fonts)
    })
...
gulp.task("pl-sass", function() {
  return gulp
    .src(path.resolve(paths().source.css, "sass/**/*.scss"))
    .pipe(
      sass({
